    ...
    <div class="container">
       ...
       <div class="row align-items-center">
          <div class="col-md-12 col-lg-8">
             ...
             <img src="images/s2.png" class="img-fluid d-block m-auto">
          </div>
             {!! $data->body !!}
          </div>
          <div class="col-md-4 d-sm-none d-none d-lg-block">
             <img src="images/s2.png" class="img-fluid d-block ml-auto">
          </div>
       </div>
    </div>
 </section>
    ...
    <div class="container">
       <div class="card shadow py-5 px-4 border-0">
         ...
         @endif
          ...
          <form class="panel py-4">
             <div class="row" action="{{route('requests.store')}}" method="POST">
               @csrf
                <div class="col-md-6">
                   {{-- <label class="floating-label"> Name*</label> --}}
                   <input type="hidden" value="Buy" name="request_type"> 
